...
const cinematicSequence = [
  { type: "image", src: openingImages[0], fallback: openingLegacyImages[0], text: "Alguns momentos não passam…", duration: 3000 },
  ...
  { type: "image", src: openingImages[3], fallback: openingLegacyImages[3], text: "Eles ficam.", duration: 1800 },
  ...
  { type: "video", src: "assets/video/momento-02.mp4", poster: openingImages[8], fallback: openingImages[0], text: "Em foto, em movimento…", duration: 4500 },
  ...
  { type: "image", src: openingImages[13], fallback: openingLegacyImages[13], text: "E principalmente em sentimento.", duration: 2200 },
  ...
  { type: "image", src: openingImages[18], fallback: openingLegacyImages[18], text: "Foi por isso que eu fiz isso pra você.", duration: 2300 },
